...
;; (setq server-host "scclin016.flatironinstitute.org")
(server-start)
...
(setenv "ANACONDA_HOME" (getenv "CONDA_PREFIX"))
...
(use-package pyvenv
  :ensure t
  :config
  (pyvenv-activate "/mnt/home/rblackwell/miniconda3/envs/emacs")
  )
...
(custom-set-variables
 ...
 '(elpy-rpc-python-command "/mnt/home/rblackwell/miniconda3/bin/python3")
...
(add-to-list 'load-path "~/projects/codes/env-module.el")
(require 'env-module)
